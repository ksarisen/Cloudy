...
contract ShardManager is Ownable {
    ...
    // we are creating a new array with the size based on the no. of filehashes the owner has
      uint[] memory ownerFilehashes = new uint[](ownerFilehashCount[msg.sender]); 
        uint counter = 0;
